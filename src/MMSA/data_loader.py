...
def MMDataLoader(args, num_workers):
    ...
    dataLoader = {
        'train': DataLoader(datasets['train'], batch_size=args['batch_size'], num_workers=num_workers, shuffle=True),
        'valid': DataLoader(datasets['valid'], batch_size=args['batch_size'], num_workers=num_workers, shuffle=True),
        'test': DataLoader(datasets['test'], batch_size=args['batch_size'], num_workers=num_workers, shuffle=False)
    }
